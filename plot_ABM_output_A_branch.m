...
vess_WSS = vess_WSS/12.96;
vess_flow = vess_flow*1e-9;
...
for t = 1:num_timesteps
    ...
    for v = 1:num_vess
        ...
        if (vess_diameter(v,t) ~= 0)
            plot([x1 x2], [y1 y2], 'Color', [1 0.55 0.55], 'LineWidth', vess_diameter(v, t)/3)
        end
    end
    ...
    for c = 1:length(curr_cells)
        ...
        plot(global_pos(1), global_pos(2), 'ro', 'MarkerSize', 3, 'MarkerFaceColor', 'r')
    end
