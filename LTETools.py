...
class Vect:
    ...
    def rand(self):
        self.x = rand.uniform(0,1)
        self.y = rand.uniform(0,1)
        self.z = rand.uniform(0,1)
...
#------------------------------------------------------------------------------
# Find the angle beween two vectors in 2D (all z components are zero)
def findangle2D(v1, v2):
    vect1 = v1.copy()
    vect1.z = 0.
    vect1.unit()
...
if __name__ == "__main__":
    ...
    angle = findangle2D(Vect(1,0,0), Vect(0,-1,0))
    print(angle)